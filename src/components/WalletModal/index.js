    ...
    >
      ...
      <Modal.Body>
        ...
        <Row className="ml-4 mr-4">
          <Col xl={6} className="text-center font-weight-bold pt-4 pb-2 pl-md-4" style={{cursor: "pointer"}}><a onClick={() => {login(); props.onHide();}}><img className="img-fluid" src={MetamaskLogo} /><p>Metamask</p></a></Col>
          <Col xl={6} className="text-center font-weight-bold pt-4 pb-2 pl-md-3" style={{cursor: "pointer"}}><a onClick={() => {walletConnectLogin(); props.onHide();}}><img className="img-fluid" src={TrustWalletLogo} /><p>Trust Wallet</p></a></Col>
          ...
          <Col xl={6} className="text-center font-weight-bold pt-3 pb-2 pl-md-3" style={{cursor: "pointer"}}><a onClick={() => {walletConnectLogin(); props.onHide();}}><img className="img-fluid" src={WalletConnectLogo} /><p>WalletConnect</p></a></Col>
        </Row>
        <hr/>
